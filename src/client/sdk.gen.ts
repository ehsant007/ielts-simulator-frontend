 ...
 */
export const createMessageStream = <ThrowOnError extends boolean = true>(options: Options<CreateMessageStreamData, ThrowOnError>) => {
    return (options.client ?? client).post<CreateMessageStreamResponses, CreateMessageStreamErrors, ThrowOnError>({
