...
export function createHighlightStore() {
	return createStore<HighlightStore>((set, get) => (
		{
			highlights: {},
...
function _removeHighlight(
	...
	setHighlights: HighlightStore["setHighlights"],
	groupId: number,
) {
...
let nextGroupId = 0
function _highlightSelectedText(setHighlights: HighlightStore["setHighlights"]) {
